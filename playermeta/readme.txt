This script takes the output of "playerctl metadata" and converts it into JSON format. I haven't extensively tested it, so there may be some fringe cases that break it.
